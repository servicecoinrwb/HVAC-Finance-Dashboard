...
// --- MODALS ---
// Note: In a larger application, each of these modals would be in its own file.
// For simplicity here, we're keeping them in the same file as the view that uses them.
...
const BillingView = () => {
    const { invoices, quotes, workOrders, customers, handlers, setEditingInvoice, setEditingQuote, editingInvoice, editingQuote } = useWorkOrderContext();
